# AssemblyAI feedback ledger

This ledger contains AssemblyAI substrate feedback only. Certain implementation notes are kept separately in `../certain/IMPLEMENTATION_NOTES.md` and are not provider feedback.
